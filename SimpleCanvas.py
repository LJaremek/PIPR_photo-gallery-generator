class Canvas:
    ...
    def _add_spaces(self, word):
        """
        Add spaces to pixels when the canvas is printing.
        """
        word = list(str(word))
        while len(word) < 4:
            word.insert(0, " ")
    ...
    def show(self):
        """
        Printing the canvas on the screen.
        """
    ...
    def cut_canvas(self):
        """
        Function cuts unnecessary edges of the canvas.
        """
    ...
    def _gen_name(self):
        """
        Function generate name for photo.
        """
    ...
    def find_free_place(self, width, height):
        """
        Looking for free place for photo on the canvas.
        """
